...
#include "../utilities/mathematics/binary_number_tools.hpp"
                                                ...
                                                //  bit permutations
#include "../utilities/mathematics/fermions.hpp"//  For binary encoding of 
                                                //  fermion operator commutations
#include "../basis/fermion_fock_basis.hpp"      //  Fermion Fock basis
	    ...
	    if(this->m_data.m_matrixAllocated)
	    {
            ...
            for(int i=lowerRowLimit;i<=upperRowLimit;++i)
            {
                ...
                while(tempK4!=0)    //    N iterations for N particles
                {
                    ...
                    fock_t tempK3 = inState ^ k4Occupied;  //  CHANGED 24/09/2014 fock_t tempK4 = inState;
