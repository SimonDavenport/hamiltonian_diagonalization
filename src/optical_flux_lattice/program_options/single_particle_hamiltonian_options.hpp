...
namespace myOptions
{
    ...
    inline void AddSingleParticleArrayOptions(po::options_description& singleParticleOpt)
    {
        singleParticleOpt.add_options()
        ...
        ("calculate-bandstructure",po::value<bool>()->default_value(false),
         "Set to 1 to calculate single particle band structure (automatically set if the plot-bandstructure option is set).\n")
        ("calculate-band-width",po::value<bool>()->default_value(false),
         "Set to 1 to calculate single particle band width as a function of lattice depth from 0.1 to 5.0 (automatically set if plo-band-width option is set).\n")
        ("calculate-magnetization",po::value<bool>()->default_value(false),
         "Set to 1 to calculate single particle magnetization (automatically set if plot-magnetization option is set).\n");
    }
    
    inline po::options_description GetSingleParticlePlotOptions()
    {
        po::options_description plotOpt("Plot Options");
	    plotOpt.add_options()
	    ("plot-bandstructure",po::value<bool>()->default_value(false),
	    "Set to 1 to make a pdf plot of the single particle band structure.\n")
	    ...
	    ("plot-band-width",po::value<bool>()->default_value(false),
	    "Set to 1 to make a pdf plot of single particle band width and band gap vs lattice depth (V0) from 0.1 tp 5.0.\n")
	    ("plot-magnetization",po::value<bool>()->default_value(0),
	     "Set to 1 to generate a plot of the magnetization map\n")
