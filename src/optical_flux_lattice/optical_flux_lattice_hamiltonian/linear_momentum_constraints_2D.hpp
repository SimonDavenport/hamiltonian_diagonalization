...
//  Include definition of a modulo function
#include "../../utilities/mathematics/modulo.hpp"

//  Include definitions of kState_t
...
namespace diagonalization
{
    bool TestLinearMomentumSector2(const fock_t state,const kState_t kxTot,
        const kState_t kyTot,const kState_t dimX,const kState_t dimY);
    ...
    kState_t StateAddition(const kState_t k1,const kState_t k2,
        const kState_t dimX1,const kState_t dimY1,const kState_t dimX2,
        const kState_t dimY2);

    kState_t StateSubtraction(const kState_t k1,
        const kState_t k2,const kState_t dimX1,const kState_t dimY1,
