...
///////     LIBRARY INCLUSIONS     /////////////////////////////////////////////
#include "single_particle_parameters.hpp"
...
SingleParticleParameters::SingleParticleParameters()
:   m_theta(0.3),
    m_V0(4.0),
    m_epsilon(0.4),
    m_kappa(1.0),
...
SingleParticleParameters::SingleParticleParameters(
    const SingleParticleParameters& other)  //!<    Instance of the object
...
SingleParticleParameters& SingleParticleParameters::operator=(
    const SingleParticleParameters& other)  //!<    Instance of the object
{
    m_theta = other.m_theta;
    m_V0 = other.m_V0;
...
////////////////////////////////////////////////////////////////////////////////
//! \brief A constructor for the Hamiltonian parameters stuct that gets the
...
////////////////////////////////////////////////////////////////////////////////
//! \brief Read model parameters for a specified file.
//! 
////////////////////////////////////////////////////////////////////////////////

void SingleParticleParameters::ReadFromFile(
...
////////////////////////////////////////////////////////////////////////////////
//! \brief Generate an output file name containing the current model parameters
//!
////////////////////////////////////////////////////////////////////////////////

void SingleParticleParameters::GenerateParametersFile() const
{
    std::stringstream parameters;
    
    //  Write the text contained within the parameters file
...
void SingleParticleParameters::ReadFromSql(
...
////////////////////////////////////////////////////////////////////////////////
//! \brief Default MPI function to synchronise all variables with those on the 
//! given node
//! 
////////////////////////////////////////////////////////////////////////////////

void SingleParticleParameters::MpiSynchronize(
