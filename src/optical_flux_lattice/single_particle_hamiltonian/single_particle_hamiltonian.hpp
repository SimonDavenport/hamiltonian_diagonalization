...
#ifndef _SINGLE_PARTILCE_HAMILTONIAN_HPP_INCLUDED_
#define _SINGLE_PARTILCE_HAMILTONIAN_HPP_INCLUDED_

///////     LIBRARY INCLUSIONS     /////////////////////////////////////////////

#include "../program_options/single_particle_hamiltonian_options.hpp"    
                                                    //  Declaration of command line options
#include "single_particle_parameters.hpp"           //  A data structure to contain all 
...
//////////////////////////////////////////////////////////////////////////////////
//! \brief Explicitly define the hexagonal lattice reciprocal lattice vectors
//! as LatticeVector2D objects 
//!
//////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////
//! \brief The SingleParticleHamiltonian class contains a matrix representation of
...
class SingleParticleHamiltonian
{
    ...
    friend class SingleParticleHamiltonianArray;
    ...
    bool m_bandsCalculated;
                        ...
                        //!
    SingleParticleParameters m_params; 
                        //!<    Class internal copy of 
                        //!     the SingleParticleParameters struct
    ...
    SingleParticleHamiltonian(boost::program_options::variables_map* optionList,utilities::MpiWrapper& mpi);

    //  Constructor with given model parameters
    SingleParticleHamiltonian(SingleParticleParameters params);
    
    //  Copy constructor
    SingleParticleHamiltonian(const SingleParticleHamiltonian &other);
    
    //  Destructor
    ~SingleParticleHamiltonian();

    //  Copy given class and synchrnoize over all nodes  
    void MpiSynchrnoizedCopy(const SingleParticleHamiltonian &other,const iSize_t nodeId,const utilities::MpiWrapper& mpi);

    //  Put entries into difference equation to determine the Bloch wave 
    ...
    //  Return the nth eigenvalue i.e the energy in the nth band
    double GetBandEnergy(const iSize_t n) const;
    
    //  Return selected Bloch coefficients
    ...
    //  Print out the difference matrix
    void PrintDifferenceMatrix();
    
    //  Multiply Bloch states by a given phase angle
    void MultiplyByPhase(const double phaseAngle);
    
    //  Obtain the sigma_z value of band index n
    double ApplySigmaZ(const iSize_t n)  const;

    //  Obtain tables of the function sum_G a^{kx,ky}_{G,sigma} exp^(ir.(G+{kx,ky})
