...
#ifndef _PSEUDOPOTENTIAL_MODEL_DATA_HPP_INCLUDED_
...
namespace diagonalization
{
    ...
    //!
    struct PseudopotentialModelData
    {
        ...
        PseudopotentialModelData();
        PseudopotentialModelData(const iSize_t nbrParticles, const iSize_t nbrOrbitals,
                                       const std::vector<double>& pseudopotentials);
        PseudopotentialModelData(const iSize_t nbrParticles, const iSize_t nbrOrbitals,
                                       const std::vector<double>& pseudopotentials,
                                       const std::vector<double>& pseudopotentials2LL);
        ~PseudopotentialModelData();
        PseudopotentialModelData(const PseudopotentialModelData& other);
