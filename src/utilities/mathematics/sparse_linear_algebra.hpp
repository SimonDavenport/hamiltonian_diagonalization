...
#include "../data_structures/crs_sparse_matrix.hpp"  
                                            //  CRS sparse matrix class and functions 
#include "../general/cout_tools.hpp"        //  Functions to manipulate cout
#include "../wrappers/mpi_wrapper.hpp"      //  For MPI functionality
#include "../general/template_tools.hpp"    //  For template function is_same
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
            ...
            T BETA)         //!<    Additional vector scale factor
        {
            ...
            //  Iterate over all sparse matrix elements
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
            ...
            const MpiWrapper& mpi)              //!<    Instance of the MPI wrapper class
        {
            ...
            //PAR_PRINT("X",x,(*dataDistribution)[id],mpi);
            //PAR_PAUSE(mpi);
            ...
            { 
                if(mpi.m_id == i)
                {
                    //  Copy x into a inputVectorBuffer
            ...
            //PAR_PRINT("inputVectorBuffer",inputVectorBuffer,bufferDim);
            //PAR_PAUSE();
            ...
            //PAR_PRINT("outputVectorBuffer",outputVectorBuffer,bufferDim);
            //PAR_PAUSE();
            ...
            //PAR_PRINT("Y",y,(*dataDistribution)[id],mpi);  
            //PAR_PAUSE(mpi);
