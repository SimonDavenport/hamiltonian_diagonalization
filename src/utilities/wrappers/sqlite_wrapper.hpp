...
#include "../general/dcmplx_type_def.hpp"   //  For complex numbers
#include "../general/template_tools.hpp"    //  For the is_same template function
#include "../general/cout_tools.hpp"        //  For manipulation of std::cout

#include <sqlite3.h>		    //	Include the SQLite library
#include <iostream>             //  For in/out formatting
#include <iomanip>              //  For in/out formatting
...
namespace utilities
{
    class SqliteVariable
    {
        ...
        //  Comparison operator and overloads
        ...
        //  Constructor without setting data values
        SqliteVariable(const std::string name,const sqlType_t type);

        //////////////////////////////////////////////////////////////////////////////////
        //! \brief Template method setting explicit data values
        //!
        //////////////////////////////////////////////////////////////////////////////////
        template<typename T> 
    ...
    class SqliteRow
    {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        //! \brief Template for the AddField function to pass arguments to the 
        ...
        ////////////////////////////////////////////////////////////////////////////////
        //! \brief Template for the UpdateValue function to pass arguments to the 
        //! SqliteVariable constructor
        //!
        ////////////////////////////////////////////////////////////////////////////////
        ...
        ////////////////////////////////////////////////////////////////////////////////
        //! \brief Template to get the parameter value corresponding to the specified 
        ...
        {
            //  Find the name of the field in the list m_data

            for(int i=0;i<m_fields.size();i++)
            {
                if(name == m_fields[i].GetName())
                {
                    //std::cout<<" GET VALUE: "<<name<<" : "<<m_data[i].GetData()<<std::endl;
