...
#include "../mathematics/clebsch_gordan_coefficients.hpp"
                            //  Functions to calcualted Clebsch-Gordan coefficients
#include "../data_structures/multi_key_hash.hpp"
                            //  MultiHashMap data structure to 
                            //  efficiently store the coefficient values
...
class ClebschGordanCoefficients
{
    ...
    //static const maxQuantumNumber = 128;
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
        ...
        const j_type j2)       //!<    j1 between 0 and 256 represeting 2*j2
    {
        ...
        #if _DEBUG_
        std::cout<<"MAP SIZE IS NOW: "<<m_map.Size()<<std::endl;
        #endif
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    double Value(
        ...
        const
    {
        //  Convert types to unsigned to match tabulated values
