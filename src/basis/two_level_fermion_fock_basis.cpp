...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Comparison operator for TwoLevelFockState type
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Equals operator for TwoLevelFockState type
    //! used in binary search algorithm
    //!
    ////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Overload the out stream operator to allow simple printing of  class
    //! data.
    //!
    ////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Constructor for a TwoLevelFockState type
    //!
    ////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Clear current memory allocation
    //!
    ////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    //////////////////////////////////////////////////////////////////////////////////
    //! \brief Add a single state to the basis
    //! 
    //////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
        ...
        const
    {
        if(m_basisStored)
        {
            ...
            //  Error code in binary search is the maximum value of the fock_t type
            ...
            if(_SEARCH_ERROR_CODE_ == index)
            {
                ...
                //std::cerr<<"STATE 1 WAS: "<<std::bitset<64>(state1)<<std::endl;
                //std::cerr<<"STATE 2 WAS: "<<std::bitset<64>(state2)<<std::endl;
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    //////////////////////////////////////////////////////////////////////////////////
    //! \brief Set the first Fock state in the list.
    //! 
    //////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    //////////////////////////////////////////////////////////////////////////////////
    //! \brief Generate subsequent Fock states from the previous state
    //! 
    //////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    //////////////////////////////////////////////////////////////////////////////////
    //! \brief Get the dimension of the internal array
    //! 
    //////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
        ...
        utilities::MpiWrapper& mpi) //!<    Instance of the mpi wrapper class
    {
        ...
        //fock_t fullFockSpaceDim = this->GetFullFockSpaceDimension(nbrParticles,nbrOrbitals1,nbrOrbitals2);
        ...
        if(0 == mpi.m_id)	// FOR THE MASTER NODE
        {
            for(fock_t i=0;i<sectorTotalDimension;++i)
            {
                PRINT("allowedFockStates1",std::bitset<10>(fockStateBuffer1[i]));
                PRINT("allowedFockStates2",std::bitset<10>(fockStateBuffer2[i]));
            }
        
            //PRINT("allowedFockStates1",fockStateBuffer1,sectorTotalDimension);
            //PRINT("allowedFockStates2",fockStateBuffer2,sectorTotalDimension);
        }
        PAR_PAUSE();
        #endif
        ...
        {
            std::cout<<"m_basis["<<i<<"] = "<<m_basis[i]<<std::endl;
        
            //PAR_PRINT("m_basis",std::bitset<64>(m_basis[i]));
            //PRINT("m_fockBasis",m_fockBasis[i]);
        }
        //PAR_PAUSE();
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Return a copy of the Fock basis to the given buffer
    //!
    ////////////////////////////////////////////////////////////////////////////////
...
//\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\//
    ...
    ////////////////////////////////////////////////////////////////////////////////
    //! \brief Set the stored Fock basis from an external buffer
    //!
    ////////////////////////////////////////////////////////////////////////////////
